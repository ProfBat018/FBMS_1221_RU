...
5. Классы.
6. Структуры.
7. Свойства и индексаторы.
8. Строки.
9. Класс Object.
10. Коллекции.
11. Интерфейсы.
12. Ковариантность и контрвариантность интерфейсов. 
13. Обобщения(Generic) where keyword. 
14. Файлы и потоки (IDisposable)
15. Сериализация.
16. Exception
17. StackTrace
...
Уроки для повторения - https://metanit.com/cpp/tutorial/
Начиная с главы 5 до главы 9 включительно. 


Пройденные темы по ООП. 
1. Структуры и Классы
2. Конструкторы и деструкторы
3. Конструкторы копирования и переноса
4. Методы(Шаблонные, inline, перегрузки и т.д.)
5. Инкапсуляция(сюда входит все управление доступом, так же модификаторы типов данных)
6. Дружественные функции и классы.
7. Статические члены
8. Перечисления(enum)
9. Полиморфизм. Типы полиморфизма.
